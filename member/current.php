...
<div class="card-title">Current Wallet To Top-Up Wallet</div>
</div>
...
<?php if(isset($_REQUEST['s'])==1){?><p align="center" style="color:#FF0000; padding-bottom:8px;font-size:16px;">Minimum Transfer Amount is Rs.&nbsp;<?=getSettingsTransfer($conn,'minimum')?></p><?php }?>

<h3 align="center" style="color:#660000;">Current Wallet: <?=getAvailableWallet($conn,$userid)?></h3>
<div>&nbsp;</div>
<?php if(getSettingsOnoff($conn,'currenttofund')=='A'){?>
