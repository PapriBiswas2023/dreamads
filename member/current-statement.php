...
<div class="card-title">Current Wallet To Topup Wallet Transfer Statement</div>
</div>
<div class="card-body" style="overflow:auto;">
<table class="table table-head-bg-primary mt-1" style="background:#CCCCCC;">
<thead>
<tr align="center">
<th align="center">Sl_No</th>
<th align="center">Current_Wallet</th>
<th align="center">Charge</th>
<th align="center">Topup_Wallet</th>
...
<div class="card" style="background:#CCCCCC;">
<div class="card-header">
<div class="card-title">Current Wallet Received From Administrator Statement</div>
</div>
...
$where="WHERE `userid`='".getMember($conn,$_SESSION['mid'],'userid')."' AND `wallet`='Current Wallet' ORDER BY `id` DESC";
include('pagination.php');
$num=numrows($result);
$i=1;
if($num>0)
