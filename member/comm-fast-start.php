...
<div class="card-title">Commission Fast Start Club Coin</div>
</div>
...
<tbody>
<?php
$tname='da_commission_fast_start_club';
$lim=100;
$tpage='comm-fast-start.php';
...
<td align="center"><?=$fetch['nodirect']?></td>
<td align="center"><?=$fetch['coin']?></td>
