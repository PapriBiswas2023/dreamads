...
<div class="card-title">IMPS Withdrawal Statement</div>
</div>
...
$lim=100;
$tpage='withdrawal-imps-statement.php';
...
<td align="center"><?=$fetch['imps']?></td>
<td align="center"><?=$fetch['payout']?></td>
<td align="center" style="color:#FF0000;"><?=$fetch['status']?></td>
<td align="center"><?=$fetch['message']?></td>
<td align="center"><?=$fetch['utr']?></td>
<td align="center"><?=$fetch['orderid']?></td>
