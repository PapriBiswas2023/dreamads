...
<div class="card-title">Member Renewal</div>
</div>
<div align="center">&nbsp;</div>
<?php if(isset($_REQUEST['e'])==1){?><p align="center" style="color:#FF0000;">Insufficient wallet balance!</p><?php }?>


<h2 align="center" style="color:#0000FF;">Renewal Amount : Rs.  <?=getSettingsJoining($conn,'joining')?></h2>
<h2 align="center" style="color:#0000FF;">Topup Wallet: Rs.  <?=getFundWallet($conn,$userid)?></h2>

<form class="form" action="renewal-process.php" method="post">
<div class="card-action" align="center">
<button class="btn btn-success" onClick="return confirm('Are you sure want to active now?');">Renew Now</button>
</div>
</form>
</div>
