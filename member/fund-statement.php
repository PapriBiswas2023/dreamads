...
<div class="card-title">Topup Wallet Transfer Statement</div>
</div>
...
<div class="card" style="background:#CCCCCC;">
<div class="card-header">
<div class="card-title">Topup Received Statement</div>
</div>
<div class="card-body" style="overflow:auto;background:#CCCCCC;">
...
<div class="card" style="background:#CCCCCC;">
<div class="card-header">
<div class="card-title">Fund Received From Administrator Statement</div>
</div>
<div class="card-body" style="overflow:auto;background:#CCCCCC;">
...
$lim=100;
$tpage='fund-statement.php';
$where="WHERE `userid`='".getMember($conn,$_SESSION['mid'],'userid')."' AND `wallet`='Fund Wallet' ORDER BY `id` DESC";
include('pagination.php');
$num=numrows($result);
$i=1;
if($num>0)
