...
<form name="frm1" method="post" action="package-statement.php?act=search"><input type="text" name="search" id="search" class="form-control input-line input-medium" value="<?=$_REQUEST['search']?>" required placeholder="User ID" style="width:150px;" />
</form>
</div>
</td>
</tr>
...
<?php
$tname='da_member_package';
$lim=100;
$tpage='package-statement.php';
...
<td align="center" style="padding:3px;"><?=ucwords(getSettingsPackage($conn,$fetch['package'],'package'))?></td>
