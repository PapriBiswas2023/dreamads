...
<h4 class="card-title">Level Add Bonus Statement</h4>
...
<tr>
<td>
<div align="right" style="padding:5px;"><form name="frm1" method="post" action="commission-level-add.php?act=search"><input type="text" name="search" id="search" class="form-control input-line input-medium" value="<?=$_REQUEST['search']?>" required placeholder="User ID" style="width:150px;" />
</form></div>
</td>
</tr>
</table>
...
<th style="text-align:center;">Name</th>
<th style="text-align:center;">Package_ID</th>
...
$lim=100;
$tpage='commission-level-add.php';
...
<td style="text-align:center;padding:2px;"><?=$fetch['packageid']?></td>
<td style="text-align:center;padding:2px;"><?=$fetch['level']?></td>
<td style="text-align:center;padding:2px;"><?=$fetch['bonus']?></td>
<td style="text-align:center;padding:2px;"><?php if($fetch['status']=='R'){?><span style="color:#009900;">Released</span><?php }else{?> <span style="color:#FF0000;">Holding</span><?php } ?> </td>
