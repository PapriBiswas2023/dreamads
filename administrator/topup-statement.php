...
<form name="frm1" method="post" action="topup-statement.php?act=search"><input type="text" name="search" id="search" class="form-control input-line input-medium" value="<?=$_REQUEST['search']?>" required placeholder="User ID" style="width:150px;" />
</form>
</div>
</td>
</tr>
...
<td align="center" style="padding:3px;"><?=$fetch['topupid']?></td>
<td align="center" style="padding:3px;"><?=ucwords(getMemberUserid($conn,$fetch['topupid'],'name'))?></td>
