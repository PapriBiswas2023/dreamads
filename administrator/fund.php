...
<h4 class="card-title">Topup Wallet To Others Member Topup Wallet Statement</h4>
...
<div align="right" style="padding:5px;"><form name="frm1" method="post" action="fund.php?act=search"><input type="text" name="search" id="search" class="form-control input-line input-medium" value="<?=$_REQUEST['search']?>" required placeholder="User ID" style="width:250px;" />
</form></div>
...
<th style="text-align:center;">To_User_ID</th>
<th style="text-align:center;">Name</th>
...
<td align="center" style="padding:3px;"><?=$fetch['toid']?></td>
<td align="center" style="padding:3px;"><?=ucwords(strtolower(getMemberUserid($conn,$fetch['userid'],'name')))?></td>
