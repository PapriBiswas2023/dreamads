...
$sqlm="SELECT * FROM `da_member` WHERE `date` BETWEEN '".$_REQUEST['formdate']."' AND '".$_REQUEST['todate']."' AND `paystatus`='A' ORDER BY `id` DESC";
}
else{
$sqlm="SELECT * FROM `da_member` WHERE `paystatus`='A' ORDER BY `id` DESC";
}
